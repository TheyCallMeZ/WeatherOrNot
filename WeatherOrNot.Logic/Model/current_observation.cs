namespace WeatherOrNot.Logic.Model
{
    ...
    public partial class current_observation
    {
        ...
        private byte relative_humidityField;

        private string wind_stringField;

        private string wind_dirField;

        private ushort wind_degreesField;

        private decimal wind_mphField;

        private ushort wind_ktField;
        ...
        private sbyte windchill_fField;

        private sbyte windchill_cField;

        private decimal visibility_miField;
